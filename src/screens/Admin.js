                ...
                <div className="container-fluid" style={{/*background: 'linear-gradient(to right, #000000, #2e8b57,#2e8b57, #000000)' backgroundColor: '#013220'*/ background: 'linear-gradient(to right, #000000,#2e8b57, #000000)'}}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav me-auto mb-2">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link active fs-5" to="/fruitscreat">Add Items</Link>
                            </li>
        ...
        <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner" id='carousel'>
            ...
            <div className="carousel-item active">
              <img src="https://marketplace.canva.com/EAFMoNgBHE8/1/0/1600w/canva-white-fresh-fruit-instagram-post-i19D8Jv5Ab0.jpg" className="d-block w-100" style={{ filter: "brightness(100%)" }} alt="..." />
            </div>
            ...
            <div className="carousel-item">
              <img src="https://www.fruitdelivery.com.sg/image/cache/catalog/mainbanner/fruitdelivery-fruits-selection-1903x838.jpg" className="d-block h-20 w-100" style={{ filter: "brightness(100%)" }} alt="..." />
            </div>
          </div>
